 ...
 */
static int isleap(long year) { return ((year % 4 == 0 && year % 100 != 0) || year % 400 == 0); }  // end isleap
  ...
  again:
    switch (*++format) {
      ...
      case 'v':  // date as dd-bbb-YYYY
        sprintf(tbuf, "%2d-%3.3s-%4ld", range(1, timeptr->tm_mday, 31), LC_ABMON[range(0, timeptr->tm_mon, 11)],
