...
float kelvin_to_celsius(float kelvin) { return kelvin - 273.15f; }  // end kelvin_to_celsius

float kelvin_to_fahrenheit(float kelvin) { return kelvin * (9.f / 5.f) - 459.67f; }  // end kelvin_to_fahrenheit

float celsius_to_kelvin(float celsius) { return celsius + 273.15f; }  // end celsius_to_kelvin

float celsius_to_fahrenheit(float celsius) { return celsius * (9.f / 5.f) + 32.f; }  // end celsius_to_fahrenheit
...
int meterspersecond_to_beaufort(float meterspersecond) {
  int beaufort = (int) ((powf(1 / 0.836f, 2.f / 3.f) * powf(meterspersecond, 2.f / 3.f)) + .5f);
  return beaufort > 12 ? 12 : beaufort;
}  // end meterspersecond_to_beaufort

float hectopascals_to_pascals(float hectopascals) { return hectopascals * 100.f; }  // end hectopascals_to_pascals
...
float hectopascals_to_millibars(float hectopascals) { return hectopascals * 1.f; }  // end hectopascals_to_millibars
...
float meters_to_kilometers(float meters) { return meters * 0.001f; }  // end meters_to_kilometers

float meters_to_miles(float meters) { return meters * 6.214e-4f; }  // end meters_to_miles

float meters_to_feet(float meters) { return meters * 3.281f; }  // end meters_to_feet

float millimeters_to_inches(float millimeter) { return millimeter / 25.4f; }  // end milimeters_to_inches

float millimeters_to_centimeters(float millimeter) { return millimeter / 10.0f; }  // end milimeters_to_centimeter
