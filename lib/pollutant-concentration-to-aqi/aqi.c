...
const char *HONG_KONG_AQHI_TXT[5] = {
    "Low", "Moderate", "High", "Very High", "Hazardous",
};
...
int compute_nepm_aqi(float std, float c) { return (int) round(c / std * 100); }  // end compute_nepm_aqi

int compute_piecewise_aqi(float i_lo, float i_hi, float c_lo, float c_hi, float c) {
  return min(i_hi, max(i_lo, round((((float) (i_hi - i_lo)) / ((float) (c_hi - c_lo))) * (c - c_lo) + i_lo)));
 ...
 */
int australia_aqi(float co_8h, float no2_1h, float o3_1h, float o3_4h, float so2_1h, float pm10_24h, float pm2_5_24h) {
  int aqi = 0;
...
int canada_aqhi(float no2_3h, float o3_3h, float pm2_5_3h) {
  return max(
      1, (int) round((1000 / 10.4) * ((exp(0.000273533 * o3_3h) - 1)     // 0.000537 * 1ppb/1.9632 μg/m^3 = 0.000273533
 ...
 */
int china_aqi(float co_1h, float co_24h, float no2_1h, float no2_24h, float o3_1h, float o3_8h, float so2_1h,
 ...
 */
int hong_kong_aqhi(float no2_3h, float o3_3h, float so2_3h, float pm10_3h, float pm2_5_3h) {
  float ar = ((exp(0.0004462559 * no2_3h) - 1) * 100) + ((exp(0.0001393235 * so2_3h) - 1) * 100) +
             ((exp(0.0005116328 * o3_3h) - 1) * 100) +
             fmax(((exp(0.0002821751 * pm10_3h) - 1) * 100), ((exp(0.0002180567 * pm2_5_3h) - 1) * 100));
  if (ar <= 1.88) {
    return 1;
  } else if (ar <= 3.76) {
    return 2;
 ...
 */
int india_aqi(float co_8h, float nh3_24h, float no2_24h, float o3_8h, float pb_24h, float so2_24h, float pm10_24h,
              float pm2_5_24h) {
  int aqi = 0;
  float i_lo, i_hi;
  float c_lo, c_hi;
 ...
 */
int singapore_psi(float co_8h, float no2_1h, float o3_1h, float o3_8h, float so2_24h, float pm10_24h, float pm2_5_24h) {
  int psi = 0;
  float i_lo, i_hi;
  float c_lo, c_hi;
 ...
 */
int south_korea_cai(float co_1h, float no2_1h, float o3_1h, float so2_1h, float pm10_24h, float pm2_5_24h) {
  int cai = 0;
  float i_lo, i_hi;
  float c_lo, c_hi;
 ...
 */
int united_kingdom_daqi(float no2_1h, float o3_8h, float so2_15min, float pm10_24h, float pm2_5_24h) {
  // Pollutant averages are rounded to nearest integer
  if (o3_8h >= 240.5 || no2_1h >= 600.5 || so2_15min >= 1064.5 || pm2_5_24h >= 70.5 || pm10_24h >= 100.5) {
    return 10;
  } else if (o3_8h >= 213.5 || no2_1h >= 534.5 || so2_15min >= 887.5 || pm2_5_24h >= 64.5 || pm10_24h >= 91.5) {
    return 9;
  } else if (o3_8h >= 187.5 || no2_1h >= 467.5 || so2_15min >= 710.5 || pm2_5_24h >= 58.5 || pm10_24h >= 83.5) {
    return 8;
  } else if (o3_8h >= 160.5 || no2_1h >= 400.5 || so2_15min >= 532.5 || pm2_5_24h >= 53.5 || pm10_24h >= 75.5) {
    return 7;
  } else if (o3_8h >= 140.5 || no2_1h >= 334.5 || so2_15min >= 443.5 || pm2_5_24h >= 47.5 || pm10_24h >= 66.5) {
    return 6;
  } else if (o3_8h >= 120.5 || no2_1h >= 267.5 || so2_15min >= 354.5 || pm2_5_24h >= 41.5 || pm10_24h >= 58.5) {
    return 5;
  } else if (o3_8h >= 100.5 || no2_1h >= 200.5 || so2_15min >= 266.5 || pm2_5_24h >= 35.5 || pm10_24h >= 50.5) {
    return 4;
  } else if (o3_8h >= 66.5 || no2_1h >= 134.5 || so2_15min >= 177.5 || pm2_5_24h >= 23.5 || pm10_24h >= 33.5) {
    return 3;
  } else if (o3_8h >= 33.5 || no2_1h >= 67.5 || so2_15min >= 88.5 || pm2_5_24h >= 11.5 || pm10_24h >= 16.5) {
    return 2;
  } else {
    return 1;
  }
 ...
 */
int united_states_aqi(float co_8h, float no2_1h, float o3_1h, float o3_8h, float so2_1h, float so2_24h, float pm10_24h,
                      float pm2_5_24h) {
  int aqi = 0;
  float i_lo, i_hi;
  float c_lo, c_hi;
...
int calc_australia_aqi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                       const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                       const float pm2_5[24]) {
...
int calc_canada_aqhi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                     const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                     const float pm2_5[24]) {
...
int calc_china_aqi(const float co[24], const float nh3[24], const float no[24], const float no2[24], const float o3[24],
                   const float pb[24], const float so2[24], const float pm10[24], const float pm2_5[24]) {
  ...
  float pm10_24h = avg_conc(pm10, 24);
  float pm2_5_24h = avg_conc(pm2_5, 24);
  return china_aqi(co_1h, co_24h, no2_1h, no2_24h, o3_1h, o3_8h, so2_1h, so2_24h, pm10_24h, pm2_5_24h);
}  // end calc_china_aqi

int calc_european_union_caqi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                             const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                             const float pm2_5[24]) {
  float no2_1h = avg_conc(no2, 1);
  float o3_1h = avg_conc(o3, 1);
...
int calc_hong_kong_aqhi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                        const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                        const float pm2_5[24]) {
  float no2_3h = avg_conc(no2, 3);
  float o3_3h = avg_conc(o3, 3);
...
int calc_india_aqi(const float co[24], const float nh3[24], const float no[24], const float no2[24], const float o3[24],
                   const float pb[24], const float so2[24], const float pm10[24], const float pm2_5[24]) {
  float co_8h = avg_conc(co, 8);
  ...
  float pm10_24h = avg_conc(pm10, 24);
  float pm2_5_24h = avg_conc(pm2_5, 24);
  return india_aqi(co_8h, nh3_24h, no2_24h, o3_8h, pb_24h, so2_24h, pm10_24h, pm2_5_24h);
}  // end calc_india_aqi

int calc_singapore_psi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                       const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                       const float pm2_5[24]) {
  float co_8h = avg_conc(co, 8);
  float no2_1h = avg_conc(no2, 1);
...
int calc_south_korea_cai(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                         const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                         const float pm2_5[24]) {
  float co_1h = avg_conc(co, 1);
  float no2_1h = avg_conc(no2, 1);
...
int calc_united_kingdom_daqi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                             const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                             const float pm2_5[24]) {
  float no2_1h = avg_conc(no2, 1);
  float o3_8h = avg_conc(o3, 8);
...
int calc_united_states_aqi(const float co[24], const float nh3[24], const float no[24], const float no2[24],
                           const float o3[24], const float pb[24], const float so2[24], const float pm10[24],
                           const float pm2_5[24]) {
  float co_8h = avg_conc(co, 8);
  float no2_1h = avg_conc(no2, 1);
  ...
  float pm10_24h = avg_conc(pm10, 24);
  float pm2_5_24h = avg_conc(pm2_5, 24);
  return united_states_aqi(co_8h, no2_1h, o3_1h, o3_8h, so2_1h, so2_24h, pm10_24h, pm2_5_24h);
}  // end calc_united_states_aqi

/* Fast lookup for calc_aqi functions. Organized alphabetically
 * (same order as aqi_scale_t enums).
 */
static int (*CALC_AQI_LOOKUP_TABLE[NUM_AQI_SCALES])(const float[24], const float[24], const float[24], const float[24],
                                                    const float[24], const float[24], const float[24], const float[24],
                                                    const float[24]) = {
    calc_australia_aqi, calc_canada_aqhi,   calc_china_aqi,       calc_european_union_caqi, calc_hong_kong_aqhi,
    calc_india_aqi,     calc_singapore_psi, calc_south_korea_cai, calc_united_kingdom_daqi, calc_united_states_aqi,
};

int calc_aqi(aqi_scale_t scale, const float co[24], const float nh3[24], const float no[24], const float no2[24],
             const float o3[24], const float pb[24], const float so2[24], const float pm10[24], const float pm2_5[24]) {
  return CALC_AQI_LOOKUP_TABLE[scale](co, nh3, no, no2, o3, pb, so2, pm10, pm2_5);
}  // end calc_aqi
...
static const int AQI_MAX_LOOKUP_TABLE[NUM_AQI_SCALES] = {
    AUSTRALIA_AQI_MAX, CANADA_AQHI_MAX,   CHINA_AQI_MAX,       EUROPEAN_UNION_CAQI_MAX, HONG_KONG_AQHI_MAX,
    INDIA_AQI_MAX,     SINGAPORE_PSI_MAX, SOUTH_KOREA_CAI_MAX, UNITED_KINGDOM_DAQI_MAX, UNITED_STATES_AQI_MAX,
};

int aqi_scale_max(aqi_scale_t scale) { return AQI_MAX_LOOKUP_TABLE[scale]; }  // end aqi_scale_max
...
static const char *(*AQI_DESC_LOOKUP_TABLE[NUM_AQI_SCALES])(int) = {
    australia_aqi_desc, canada_aqhi_desc,   china_aqi_desc,       european_union_caqi_desc, hong_kong_aqhi_desc,
    india_aqi_desc,     singapore_psi_desc, south_korea_cai_desc, united_kingdom_daqi_desc, united_states_aqi_desc,
};

const char *aqi_desc(aqi_scale_t scale, int val) { return AQI_DESC_LOOKUP_TABLE[scale](val); }  // end aqi_desc
...
static const aqi_desc_type_t AQI_DESC_TYPE_LOOKUP_TABLE[NUM_AQI_SCALES] = {
    AUSTRALIA_AQI_DESC_TYPE,       CANADA_AQHI_DESC_TYPE,       CHINA_AQI_DESC_TYPE,     EUROPEAN_UNION_CAQI_DESC_TYPE,
    HONG_KONG_AQHI_DESC_TYPE,      INDIA_AQI_DESC_TYPE,         SINGAPORE_PSI_DESC_TYPE, SOUTH_KOREA_CAI_DESC_TYPE,
    UNITED_KINGDOM_DAQI_DESC_TYPE, UNITED_STATES_AQI_DESC_TYPE,
};

aqi_desc_type_t aqi_desc_type(aqi_scale_t scale) { return AQI_DESC_TYPE_LOOKUP_TABLE[scale]; }  // aqi_desc_type
